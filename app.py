...
def main():
    ...
    if choice == "Home":
        ...
        st.markdown(    """
* **Python libraries:** base64, pandas, streamlit, matplotlib, seaborn, spacy, textblob, neattext, wordcloud
* **Credit:** [Curso "Learn Streamlit Python](https://www.udemy.com/course/learn-streamlit-python/)* by Jesse E. Agbe.
* **Source Code:** By *[Jesse E Agbe](https://www.youtube.com/c/JCharisTechJSecur1ty/videos)*
"""
)
